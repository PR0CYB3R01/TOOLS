...
figlet FIQRA_ID | lolcat

echo   "_____________________________________________________________"
echo   "Tools    : FIQRA_ID $white         " |lolcat
echo   "Creadby  : 0day $white   " |lolcat
echo   "Contact  : gaming.09821@gmail.com $white " |lolcat
echo   "_____________________________________________________________"
...
6) echo "created by : FIQRA_ID" | lolcat
exit
;;
